...
@RESULTSFILE = "#{locationofresults}/localdeletewhilelockedtest.results"
@XMLFILE = "#{locationforxml}/localdeletewhilelockedtest.xml"

doc = REXML::Document.new
xmldoc = doc.add_element("testsuite")
xmldoc.attributes["name"] = "LOCAL DELETE WHILE LOCKED TEST"
...
test.attributes["name"] = "LOCAL DELETE WHILE LOCKED TEST ALL"
