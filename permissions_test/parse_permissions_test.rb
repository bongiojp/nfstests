...
@RESULTSFILE = "#{locationofresults}/permissionstest.results"
@XMLFILE = "#{locationforxml}/permissionstest.xml"

doc = REXML::Document.new
xmldoc = doc.add_element("testsuite")
xmldoc.attributes["name"] = "PERMISSIONS TEST"
...
test.attributes["name"] = "PERMISSIONS TEST ALL"
