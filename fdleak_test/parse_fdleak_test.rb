...
@RESULTSFILE = "#{locationofresults}/fdleaktest.results"
@XMLFILE = "#{locationforxml}/fdleaktest.xml"

doc = REXML::Document.new
xmldoc = doc.add_element("testsuite")
xmldoc.attributes["name"] = "FD LEAK TEST"
...
test.attributes["name"] = "FD LEAK TEST"
