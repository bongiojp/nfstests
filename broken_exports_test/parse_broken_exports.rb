...
@RESULTSFILE = "#{locationofresults}/broken_exports.results"
@XMLFILE = "#{locationforxml}/broken_exports.xml"

doc = REXML::Document.new
xmldoc = doc.add_element("testsuite")
xmldoc.attributes["name"] = "BROKEN EXPORTS TEST"
...
test.attributes["name"] = "BROKEN EXPORTS TEST ALL"
