...
@RESULTSFILE = "#{locationofresults}/respect_local_locks.results"
@XMLFILE = "#{locationforxml}/respect_local_locks.xml"

doc = REXML::Document.new
xmldoc = doc.add_element("testsuite")
xmldoc.attributes["name"] = "RESPECT LOCAL LOCKS TEST"
...
test.attributes["name"] = "RESPECT LOCAL LOCKS TEST ALL"
